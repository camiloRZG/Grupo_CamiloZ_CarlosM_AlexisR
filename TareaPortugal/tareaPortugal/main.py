...
# 11 jugadores titulares (se completaron los atributos requeridos por las clases)
jugadores_titulares = [ 
    # 1 portero
    Portero('Diogo Costa', 26, 1.86, dorsal=22, atajadas_totales=115, partidos_invicto=15),
    
    # 4 defensas
    Defensa('Nuno Mendes', 23, 1.76, dorsal=19, balones_recuperados=72, tarjetas_rojas=1),
    Defensa('Ruben Dias', 29, 1.87, dorsal=4, balones_recuperados=140, tarjetas_rojas=2),
    Defensa('Gonçalo Inacio', 24, 1.85, dorsal=14, balones_recuperados=88, tarjetas_rojas=0),
    Defensa('Joao Cancelo', 32, 1.82, dorsal=2, balones_recuperados=95, tarjetas_rojas=3),
    
    # 4 mediocampistas
    Mediocampista('Joao Neves', 21, 1.74, dorsal=15, asistencias=14, tiros_libres=5),
    Mediocampista('Vitinha', 26, 1.72, dorsal=23, asistencias=32, tiros_libres=10),
    Mediocampista('Bruno Fernandes', 31, 1.79, dorsal=8, asistencias=90, tiros_libres=45),
    Mediocampista('Bernardo Silva', 31, 1.73, dorsal=10, asistencias=78, tiros_libres=12),
    
    # 2 delanteros
    Delantero('Cristiano Ronaldo', 41, 1.87, dorsal=7, goles_anotados=130, remates_al_arco=450),
    Delantero('Rafael Leao', 26, 1.88, dorsal=17, goles_anotados=38, remates_al_arco=120)
]

print("--- SIMULADOR DE CAMPEÓN DEL MUNDO ---\n")

print("Acciones en la cancha:")
print(jugadores_titulares[1].correr())           
print(jugadores_titulares[4].pasar_balon())      
print(jugadores_titulares[8].celebrar_gol())     

print(jugadores_titulares[0].despejar())         
print(jugadores_titulares[0].atajar())           

print(jugadores_titulares[3].marcar())           
print(jugadores_titulares[2].recuperar())        

print(jugadores_titulares[6].dar_pase())         
print(jugadores_titulares[5].presionar())        

print(jugadores_titulares[9].patear_al_arco())   
print(jugadores_titulares[10].regatear())        
...
rutaarchivo = 'Plantilla/titulares_portugal.csv'
