...
print(jugadores_titulares[5].dar_pase())         # Sexto jugador de la lista (Joao neves, mediocampista) presiona alo
...
print(jugadores_titulares[10].patear_al_arco())  # Onceavo jugador de la lista (Rafael Leao, delantero) regatea y deja al defensa en el camino
